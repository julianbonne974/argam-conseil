...
function getIconComponent(iconName: string) {
  ...
  return (
    <IconComponent className="w-16 h-16 text-[#b4925e]" strokeWidth={1.5} />
  );
}
        ...
        <div className="flex gap-4">
          ...
          <div>
            ...
            <p className="text-sm md:text-base text-white/90 leading-relaxed">
              Sans PER, vous perdez jusqu'à 1 590€/mois à la retraite. Le PER
              vous permet de maintenir jusqu'à 80% de votre salaire actuel.
            </p>
          </div>
        </div>
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={(value) =>
            setFormData({ ...formData, hopital: value })
          }
        >
          <SelectTrigger>
          ...
          <SelectContent>
            ...
            <SelectItem value="hopital-saint-pierre">
              Hôpital Saint-Pierre
            </SelectItem>
            <SelectItem value="hopital-saint-denis">
              Hôpital Saint-Denis
            </SelectItem>
      ...
      <div className="flex items-start gap-3">
        ...
        >
          J'accepte d'être contacté par Argam Conseils dans le cadre de ma
          demande *
        </Label>
      </div>
    ...
    <main className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-[55%_45%] gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-5xl lg:text-6xl font-light text-[#524c5d] leading-tight">
                {content.hero?.titre ||
                  "Fonctionnaires Hospitaliers à La Réunion"}
              </h1>

              {/* Sous-titre accrocheur */}
              <h2 className="text-2xl lg:text-3xl font-medium text-[#b4925e] mt-6">
                {content.hero?.soustitre ||
                  "Votre prime de vie chère de 53% ne compte pas pour votre retraite"}
              </h2>
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 font-light max-w-3xl mx-auto mt-6">
              {content.problematique?.soustitre ||
                "Voici l'impact concret de la non-prise en compte de votre prime de vie chère."}
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-16">
            ...
            <div className="bg-white border border-[#524c5d]/20 p-8 text-center shadow-sm">
              ...
              <p className="text-sm text-gray-600">
                {content.problematique?.revenuActuelDetail ||
            ...
            <div className="bg-white border border-red-200 p-8 text-center shadow-sm">
              ...
              <p className="text-sm text-red-600 font-medium">
                {content.problematique?.pensionSansPERDetail ||
            ...
            <div className="bg-white border-2 border-[#b4925e] p-8 text-center shadow-lg relative">
              ...
              <p className="text-sm text-[#b4925e] font-medium">
                {content.problematique?.pensionAvecPERDetail ||
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-[#524c5d] mb-6">
              {content.solutionPER?.titre ||
                "Le Plan d'Épargne Retraite : Votre Solution"}
            </h2>
            <p className="text-lg text-gray-600 font-light max-w-3xl mx-auto">
              {content.solutionPER?.soustitre ||
                "Une réponse adaptée, flexible et fiscalement avantageuse."}
            </p>
          </div>

          {/* Grid 3 cards */}
          <div className="grid md:grid-cols-3 gap-8">
            {content.solutionPER?.avantages?.map(
              (avantage: any, index: number) => (
                <div
                  key={index}
                  className="bg-white border border-[#524c5d]/20 p-10 hover:border-[#b4925e] hover:shadow-xl hover:scale-105 transition-all duration-300"
                >
              ...
              <>
                ...
                <div className="bg-white border border-[#524c5d]/20 p-10 hover:border-[#b4925e] hover:shadow-xl hover:scale-105 transition-all duration-300">
                  ...
                  <p className="text-sm text-gray-600 font-light leading-relaxed">
                    Constituez un capital qui vous permettra de compenser la
                    non-prise en compte de votre prime de vie chère.
                  </p>
                </div>
              </>
            )}
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-light mb-6">
              {content.offreExclusive?.titre ||
                "Votre Accompagnement Privilégié"}
            </h2>
            <p className="text-lg font-light opacity-90 max-w-2xl mx-auto">
              {content.offreExclusive?.soustitre ||
                "En tant qu'adhérent du COGOHR, bénéficiez d'avantages exclusifs."}
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white/10 border border-white/20 backdrop-blur-sm p-10">
              ...
              <h3 className="text-2xl font-semibold mb-6">
                {content.offreExclusive?.etudeGratuite?.titre ||
                  "Étude Personnalisée Gratuite"}
              </h3>
              <ul className="space-y-4">
                {content.offreExclusive?.etudeGratuite?.points?.map(
            ...
            <div className="bg-white/10 border-2 border-[#b4925e] backdrop-blur-sm p-10">
              ...
              />
              <h3 className="text-2xl font-semibold mb-6">
                {content.offreExclusive?.zeroFrais?.titre ||
                  "0% de Frais d'Entrée"}
              </h3>
              <ul className="space-y-4">
                {content.offreExclusive?.zeroFrais?.points?.map(
                  (point: string, i: number) => (
                    <li key={i} className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-[#b4925e] flex-shrink-0 mt-0.5" />
                      <span className="text-sm font-light">{point}</span>
          ...
          <div className="text-center mt-16">
            <Link href="#contact">
              <Button className="bg-[#b4925e] hover:bg-[#b4925e]/90 text-white px-16 py-6 text-lg">
                {content.offreExclusive?.texteBouton ||
            ...
            {content.processus?.etapes?.map((etape: any, index: number) => (
              <div key={index} className="text-center space-y-6">
                <div className="flex justify-center">
                  <div
                    className={`w-24 h-24 ${index === 2 ? "bg-[#b4925e]" : "border-4 border-[#b4925e]"} flex items-center justify-center text-3xl font-light ${index === 2 ? "text-white" : "text-[#524c5d]"}`}
                  >
                    {etape.numero}
                  </div>
                </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          ...
          {/* Grid témoignages */}
          <div className="grid md:grid-cols-3 gap-8">
            {content.temoignages?.liste?.map(
              (temoignage: any, index: number) => (
                <div
                  key={index}
                  className="bg-white border-l-4 border-[#b4925e] p-8 shadow-sm"
                >
                  <div className="flex gap-1 mb-4">
                    {Array.from({ length: temoignage.etoiles || 5 }).map(
                      (_, i) => (
                        <Star
                          key={i}
                          className="w-4 h-4 fill-[#b4925e] text-[#b4925e]"
                        />
                      ),
                    )}
                  </div>
                  ...
                  <div>
                    <p className="text-sm font-medium text-[#524c5d]">
                      {temoignage.auteur}
                    </p>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 font-light leading-relaxed">
                  {content.cta?.texte ||
                    "Ne laissez pas la perte de votre prime de vie chère impacter votre niveau de vie."}
                </p>
              </div>
              ...
              <div className="space-y-4 pt-4">
                ...
                <div className="space-y-3 text-sm text-gray-600">
                  <div className="flex items-start gap-3">
                    ...
                    <span>
                      {content.cta?.coordonnees?.adresse ||
                        "Site COGOHR - Trois-Bassins, La Réunion"}
                    </span>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p>
                        {content.cta?.coordonnees?.horaires ||
                          "Mercredi - Samedi : 9h - 18h"}
                      </p>
                      <p className="text-xs text-gray-500">
                        {content.cta?.coordonnees?.visio ||
                          "Visio disponible 7j/7 sur rendez-vous"}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <span>
                      {content.cta?.coordonnees?.telephone || "05 33 89 14 00"}
                    </span>
                  </div>
                  <div className="flex items-start gap-3">
                    <Mail className="w-4 h-4 text-[#b4925e] flex-shrink-0 mt-1" />
                    <span>
                      {content.cta?.coordonnees?.email ||
