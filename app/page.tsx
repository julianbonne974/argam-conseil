    ...
    <main className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-[60%_40%] gap-16 items-center">
            ...
            <div className="space-y-10">
              ...
              <p className="text-lg text-gray-600 leading-relaxed font-light max-w-xl">
                Argam Conseils accompagne les particuliers et les dirigeants
                dans l'optimisation globale de leur patrimoine professionnel et
                personnel à La Réunion et Bordeaux.
              </p>

              {/* CTA */}
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 pt-4">
                <Link href="/contact">
                  <button className="px-10 py-4 bg-[#b4925e] hover:bg-[#b4925e]/90 text-white text-sm uppercase tracking-wider font-medium transition-all duration-300">
                    Prendre rendez-vous
                  </button>
                </Link>
          ...
          <div className="grid md:grid-cols-[60%_40%] gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4 text-[#524c5d]/70 font-light leading-relaxed">
                <p>
                  Argam Conseils vous accompagne dans une démarche complète
                  d'optimisation de votre patrimoine. Notre expertise intègre
                  les dimensions stratégiques, fiscales, sociales, financières
                  et juridiques pour vous offrir un conseil personnalisé et
                  optimal.
                </p>
                <p>
                  Que vous soyez particulier, fonctionnaire hospitalier, ou
                  dirigeant d'entreprise, nous construisons avec vous des
                  solutions sur-mesure adaptées à vos objectifs et contraintes
                  spécifiques.
                </p>
              </div>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-8 max-w-7xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group border-[1px] border-[#524c5d]/20 p-10 transition-all duration-300 hover:border-[#b4925e] hover:shadow-md">
              <div className="space-y-6">
                ...
                <p className="text-sm text-[#524c5d]/70 leading-relaxed font-light">
                  Placement & investissement financier, patrimoine immobilier,
                  optimisation fiscale. Nous élaborons votre stratégie
            ...
            <div className="group border-[1px] border-[#524c5d]/20 p-10 transition-all duration-300 hover:border-[#b4925e] hover:shadow-md">
              <div className="space-y-6">
                ...
                <p className="text-sm text-[#524c5d]/70 leading-relaxed font-light">
                  Couverture complète pour vous et votre famille. Prévoyance,
                  santé, retraite : sécurisez votre avenir et celui de vos
                  proches.
                </p>
                <ul className="space-y-2 text-sm text-[#524c5d]/60">
            ...
            <div className="group border-[1px] border-[#524c5d]/20 p-10 transition-all duration-300 hover:border-[#b4925e] hover:shadow-md">
              <div className="space-y-6">
                ...
                <p className="text-sm text-[#524c5d]/70 leading-relaxed font-light">
                  Solutions dédiées aux entrepreneurs. Statut social,
                  rémunération, épargne salariale, trésorerie d'entreprise.
                </p>
                <ul className="space-y-2 text-sm text-[#524c5d]/60">
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="text-center space-y-6">
              ...
              <p className="text-sm text-[#524c5d]/70 leading-relaxed font-light">
                Analyse complète de votre situation actuelle pour identifier vos
                besoins et zones de risques.
              </p>
            </div>
            ...
            <div className="text-center space-y-6">
              ...
              <p className="text-sm text-[#524c5d]/70 leading-relaxed font-light">
                Élaboration d'une stratégie sur-mesure intégrant toutes les
                dimensions de votre patrimoine.
              </p>
            </div>
            ...
            <div className="text-center space-y-6">
              ...
              <p className="text-sm text-[#524c5d]/70 leading-relaxed font-light">
                Accompagnement dans la réalisation et suivi régulier pour
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-8 max-w-7xl">
          ...
          {/* Grille 3 colonnes */}
          <div className="grid md:grid-cols-3 gap-0 bg-[#f8f8f8]">
            ...
            {pageData.statistiques?.map((stat: any, index: number) => (
              <div
                ...
                className={`relative flex flex-col items-center justify-center py-12 px-6 ${
                  index < (pageData.statistiques?.length || 0) - 1
                    ? "md:border-r border-[#524c5d]/10"
                    : ""
                }`}
              >
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Bordeaux */}
            <div className="bg-white border-[1px] border-[#524c5d]/20 p-8 space-y-6">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-8 max-w-4xl">
          <div className="border-4 border-[#524c5d] p-12 md:p-16 text-center space-y-8">
            <h2 className="text-3xl lg:text-4xl text-[#524c5d] font-light">
