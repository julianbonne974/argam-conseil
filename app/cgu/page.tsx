          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="text-sm text-[#524c5d]/70 font-light leading-relaxed space-y-3">
                <p>
                  Les présentes Conditions Générales d'Utilisation (ci-après "CGU") régissent l'utilisation du site web <strong className="font-semibold text-[#524c5d]">www.argam-conseils.fr</strong> (ci-après "le Site") édité par Argam Conseils.
                </p>
                <p>
            ...
            <div className="space-y-4">
              ...
              <div className="text-sm text-[#524c5d]/70 font-light leading-relaxed space-y-3">
                ...
                <p>
                  <strong className="font-semibold text-[#524c5d]">Médiation :</strong> Conformément aux dispositions du Code de la consommation concernant le règlement amiable des litiges, Argam Conseils adhère au Service du Médiateur de l'AMF. En cas de litige, vous pouvez déposer votre réclamation sur le site : <a href="https://www.amf-france.org" target="_blank" rel="noopener noreferrer" className="text-[#b4925e] hover:underline">www.amf-france.org</a>
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4 pt-8 border-t border-[#524c5d]/10">
              ...
              <div className="text-sm text-[#524c5d]/70 font-light leading-relaxed space-y-2">
                ...
                <p><strong className="font-semibold text-[#524c5d]">Argam Conseils</strong></p>
